...
regs=[
    ...
    ('alarm/lo','Alarm low set point','F',u'°C',False,30,False),
    ('alarm/hi','Alarm high set point','F',u'°C',False,30,False),
    ('jog/lo','Stuck valve low set point','F',u'°C',False,30,False),
    ('jog/hi','Stuck valve high set point','F',u'°C',False,30,False),
    ...
    ('jog/flip','How long to blip valve to unstick it','I','cs',False,300,True),
    ('jog/wait','Time between attempts to unstick valve','I','cs',False,300,True),
